...
const ClassroomPractice = ({ classroomId, userId, roleId }) => {
  ...
  const handleDeleteExamFromClassroom = async (examId) => {
    ...
    try {
      ...
      // Sau khi xóa bài thi, gọi lại để cập nhật danh sách bài thi trong lớp học
      fetchExamsForClassroom(); // Cập nhật lại danh sách bài thi
    } catch (error) {
                          ...
                          <Card>
                            <Card.Body>
                              ...
                              <Button
                                variant="primary"
                                size="sm"
                                onClick={() => setSelectedExam(exam)} // 🔹 Chọn bài thi trước khi điều hướng
                              >
                                Vào bài thi
                              </Button>
                            </Card.Body>
